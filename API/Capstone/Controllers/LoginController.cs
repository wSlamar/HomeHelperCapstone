...
namespace Capstone.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Register(RegisterUser userParam)
        {
            ...
            User user = userDAO.AddUser(userParam.Username, userParam.Password, userParam.Role, userParam.FirstName, userParam.LastName, userParam.Email, userParam.PhoneNumber, userParam.BillingStreetAddress, userParam.BillingCity, userParam.BillingState, userParam.BillingZip);
            if (user != null)
            {
